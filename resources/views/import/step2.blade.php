	...
	@section('boxcontent')
    	<form action="{{ route('importstore2') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="alert alert-warning">
                <b>NOTE:</b> Please import the same file again!
            </div>
            <br>
            ...
            <div class="form-group">
                <input type="checkbox" name="loadagentscheck"> <label>Load to Agents:</label>
                <select class="setcategory form-control" name="loadagents">
                    @foreach($headings[0][0] as $heading)
                        <option value="{{$heading}}">{{$heading}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <label>Do not insert duplicates</label> 
            </div>
